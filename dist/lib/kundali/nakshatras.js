...
exports.NAKSHATRA_NAMES = exports.NAKSHATRAS = void 0;
exports.getNakshatraByName = getNakshatraByName;
exports.getNakshatraByIndex = getNakshatraByIndex;
exports.getPlanetRelation = getPlanetRelation;
exports.getYoniRelation = getYoniRelation;
exports.getVasyaScore = getVasyaScore;
exports.NAKSHATRAS = [
...
function getNakshatraByName(name) {
    ...
    return exports.NAKSHATRAS.find((n) => n.name.toLowerCase() === normalized ||
        n.nameDevanagari === name.trim());
}
function getNakshatraByIndex(index) {
    return exports.NAKSHATRAS.find((n) => n.index === index);
}
exports.NAKSHATRA_NAMES = exports.NAKSHATRAS.map((n) => n.name);
...
function getPlanetRelation(lord1, lord2) {
    return PLANET_FRIENDSHIPS[lord1][lord2];
}
const YONI_FRIENDSHIPS = {
...
function getYoniRelation(y1, y2) {
